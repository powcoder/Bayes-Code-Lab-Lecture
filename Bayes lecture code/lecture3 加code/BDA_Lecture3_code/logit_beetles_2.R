...
y=beetles$y; n=beetles$n; N=nrow(beetles); dose=beetles$Dose-mean(beetles$Dose)
...
res=coda.samples(model,variable.names=c("beta"),n.iter=10000,thin=1,progress.bar="none")
